				...
				for xa in self.id:
					try:
						...
						if len(xe)==1 or len(xe)==2 or len(xe)==3 or len(xe)==4 or len(xe)==5:
							pewe=[xe[0],xe[0]+"123",xe[0]+"12345",xe[0]+"1234",xe[0]+"123456","Sayang","Mantan","Kontol","Bangsat","Anjing","Freefire","Indonesia","Cinta123"]
						else:
							pewe=["Sayang","Mantan","Kontol","Bangsat","Anjing","Freefire","Indonesia","Cinta123"]
						for pwas in pewe:
			...
			with Bool(max_workers=50) as tokai:
				for xa in self.id:
					try:
						...
						xe=xu.split(" ")
						if len(xe)==1 or len(xe)==2 or len(xe)==3 or len(xe)==4 or len(xe)==5:
							pewe=[xe[0],xe[0]+"123",xe[0]+"12345",xe[0]+"1234",xe[0]+"123456","Sayang","Mantan","Kontol","Bangsat","Anjing","Freefire","Indonesia","Telaso"]
						else:
							pewe=["Sayang","Mantan","Kontol","Bangsat","Anjing","Freefire","Indonesia","Telaso"]
						for pwas in pewe:
