				...
				for xa in self.id:
					try:
						...
						if len(xe)==1 or len(xe)==2 or len(xe)==3 or len(xe)==4 or len(xe)==5:
							pewe=[xe[0],xe[0]+"123",xe[0]+"12345",xe[0]+"1234",xe[0]+"123456",xe[0]+"01",xe[0]+"02",xe[0]+"03",xe[0]+"22"]
						else:
							pewe=["Sayang","Mantan","Kontol","Bangsat","Anjing","Freefire","Indonesia","Telaso","Sundala"]
						for pwas in pewe:
				...
				for xa in self.id:
					try:
						...
						if len(xe)==1 or len(xe)==2 or len(xe)==3 or len(xe)==4 or len(xe)==5:
							...
							pewe=["Sayang","Mantan","Kontol","Bangsat","Anjing","Freefire","Indonesia","Telaso","Sundala","Kondom"]
						for pwas in pewe:
